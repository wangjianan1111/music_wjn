    ...
    public static void main(String[] args) {
        ...
        try {
            createImage(contents, sizes,
                    "d:/test/createImage.jpg",
                    "d:/test/createImage.jpg");
        } catch (IOException e) {
            e.printStackTrace();
        }

//        markImageByText("测试水印","d:/test/test.jpg","d:/test/test_text.jpg",90);

        markImageByIcon("d:/test/test.jpg",
                "d:/test/createImage.jpg", "d:/test/createImage.jpg", 0);
    }
